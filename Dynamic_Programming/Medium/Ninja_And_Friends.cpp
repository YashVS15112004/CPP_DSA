...
int maximumChocolates_MEM(int n, int m, vector<vector<int>> &grid) {
...
int maximumChocolates_OPT(int n, int m, vector<vector<int>> &grid) {
...
int main() {
    ...
    cout << maximumChocolates_OPT(n, m, matrix);
    return 0;
}
